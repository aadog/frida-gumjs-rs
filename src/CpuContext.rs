...
//         unsafe { gumjs_sys::gum_cpu_context_get_nth_argument(self.cpu_context, n) as usize }
//     }
//
...
//         unsafe {
//             gumjs_sys::gum_cpu_context_replace_nth_argument(self.cpu_context, n, value as *mut c_void)
//         }
//     }
//
//     /// Get the value of the register used for the platform calling convention's return value.
//     pub fn return_value(&self) -> usize {
//         unsafe { gumjs_sys::gum_cpu_context_get_return_value(self.cpu_context) as usize }
//     }
//
//     /// Set the value of the register used for the platform calling convention's return value.
//     pub fn set_return_value(&mut self, value: usize) {
//         unsafe {
//             gumjs_sys::gum_cpu_context_replace_return_value(self.cpu_context, value as *mut c_void)
//         }
//     }
//
